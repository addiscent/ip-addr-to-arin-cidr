...
/*
    ...
    Developer's notes:
        ...
        The source code in this file is re-used from a posting made to the
        http://php.net web site, by "info at b1g dot de".  This is the
        description of the class code:
        
            "A simple class to fetch a HTTP URL. Supports
            "Location:"-redirections. Useful for servers with (sic)
            allow_url_fopen=false. Works with SSL-secured hosts."
    
        Copious thanks to "info at b1g dot de".
    
        The code which "info at b1g dot de" posted is 8 years old, so minor
        changes in declarations were made to update it to more modern PHP
        standards.
