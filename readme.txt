/*
    ...
    Place the seven included .php files in a directory which is accessible
    on the web, e.g., http://example.com/ip-addr-to-arin-cidr/.  Load
    "index.php" in a web browser.  A self explanatory web page is shown.
    ...
    - cidr-data-set.php
    - http-request.php
    - ip-addr-to-arin-cidr.php
    - ipaddr-to-cidr-worker.php
    - ipaddress-validator.php
    - output-worker.php
